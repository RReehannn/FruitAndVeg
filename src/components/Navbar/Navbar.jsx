...
const Navbar = () => {
  ...
  return (
    <>
      ...
      font-bold uppercase"
          >
            <p className="text-primary">Fruits and Vegetables</p>
            ...
            <ul className="flex items-center gap-8 text-gray-600">
              {NavbarMenu.map((menu) => (
                <li key={menu.id}>
                  <a
                    href={menu.link}
                    className="inline-block py-1 px-3 hover:text-primary hover:shadow-
              [0_3px_0_-1px_#ef4444] font-semibold"
                  >
                    {menu.title}
                  </a>
                </li>

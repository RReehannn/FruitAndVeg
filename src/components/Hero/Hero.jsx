...
import LeafPng from "../../assets/leafbroccoli.png";
      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[650px] relative">
        ...
        <div className="flex flex-col justify-center py-14 md:py-0 relative z-10">
          <div className="text-center md:text-left space-y-6 lg:max-w[400px]">
            ...
            initial="hidden"
            animate="visible"
            className="text-5pxl lg:text-6xl font-bold leading-relaxed xl:leading-loose font-averia "
            >
              Healthy
              <br />
              Fresh{" "}
            ...
            className="text-gray-400">
              ...
              Perferendis, ipsum veritatis quaerat soluta molestiae eligendi.
              Natus quibusdam voluptatum quas minima!
            </motion.p>
